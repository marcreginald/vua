                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="tab-content">
                      ...
                      <div id="pending" class="tab-pane in active" style="display:">
                        ...
                        <div class="table-responsive m-t-30">
                            <table id="data-table-pending" data-order='[[1,"asc"]]' class="table table-bordered table-hover nowrap">
                                ...
                                <tbody id="agent-sentlist-pending" style="text-transform: capitalize;">
                                 <!-- ajax -->
                                </tbody>
                            </table>
                        </div>
                      ...
                      <div id="verified" class="tab-pane fade">
                            ...
                            <div class="table-responsive m-t-30">
                                <table id="data-table-verified" data-order='[[1,"asc"]]' class="table table-bordered table-hover nowrap"  width=1580px;>
                                    <thead>
                                        <tr class="white">
                                    ...
                                    <tbody id="agent-sentlist-verified" style="text-transform: capitalize;">
                                     <!-- ajax -->
                                    </tbody>
                                </table>
                           </div>

...
<div class="modal fade" id="mod-verifying"> <!--  -->
                ...
                <div class="modal-body">
                   ...
                   <div class="row">
                       <blockquote class="m-b-20 ">
                            <p> Are you sure you want to tag <u style="text-transform:uppercase;"> <?= (isset($transac_dat->trans_no) ? $transac_dat->trans_no : 'trans-0'); ?></u> as <strong> VERIFIED </strong>? </p> 
                ...
                <div class="modal-footer">
                   <div class="row">
                        <div class="col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-2">
                           <button class="btn btn-sm btn-block btn-success" btn="btn-genrequest" id="confirm-verification" data-crnttransnum="<?= $transac_dat->trans_no; ?>"> YES (是)</button>
                        </div>
